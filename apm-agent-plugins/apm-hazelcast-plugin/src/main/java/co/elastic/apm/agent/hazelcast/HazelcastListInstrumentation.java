...
public class HazelcastListInstrumentation extends HazelcastInstrumentation {

    public static final String instrumentedMethod = "getList";
    ...
    public ElementMatcher<? super MethodDescription> getMethodMatcher() {
        System.out.println("HazelcastListInstrumentation getMethodMatcher");
