...
public class HazelcastQueueInstrumentation extends HazelcastInstrumentation {

    public static final String instrumentedMethod = "getQueue";
    ...
    public ElementMatcher<? super MethodDescription> getMethodMatcher() {
        System.out.println("HazelcastQueueInstrumentation getMethodMatcher");
